...
class PhoneBookActivity : AppCompatActivity() {
    ...
    fun createPhoneBookList(phoneBook: PhoneBook){
        ...
        val container = findViewById<LinearLayout>(R.id.phonbook_list_container)
        for (i in 0 until phoneBook.personList.size){
            ...
            addSetOnCliskListener(phoneBook.personList.get(i),view)
            container.addView(view)
        }
    }
    fun addSetOnCliskListener(person: Person, view: View){
